...
public class loginView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setFont(new java.awt.Font("Yu Gothic UI", 3, 10)); // NOI18N
        ...
        jButton2.setFont(new java.awt.Font("Yu Gothic UI", 3, 10)); // NOI18N
        ...
        setSize(new java.awt.Dimension(688, 442));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txtUser.getText().equals("admin")&&txtPass.getText().equals("admin")) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Senha ou usuario errados!!");
        }
